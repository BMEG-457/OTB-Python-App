...
class DataReceiverThread(QtCore.QThread):
    ...
    def __init__(self, device, client_socket, tracks):
        ...
        self.recording_data = []  # List to store (timestamp, channel_data) tuples
        ...
        while self.running:
            try:
                ...
                if self.is_recording:
                    # Extract first 64 channels (HDsEMG data)
                    hdemg_data = reshaped_data[:64, :]  # Shape: (64, samples_per_packet)
    ...
    def save_recording_to_csv(self, recording_data):
        ...
        try:
            ...
            with open(filename, 'w', newline='') as csvfile:
                ...
                # Write header: Timestamp, Channel_1, Channel_2, ..., Channel_64
